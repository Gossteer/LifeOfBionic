...
insert into [dbo].[Role] (Write,CardDesign,AcceptanceMedication,ResolutionStatement,id_SpecialityPersonal)
values (@Write,@CardDesign,@AcceptanceMedication,@ResolutionStatement,@id_SpecialityPersonal)